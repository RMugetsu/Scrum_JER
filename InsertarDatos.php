...
<body>	
	<?php session_start()?>
		<form method="POST" action="ActualizacionDatos.php">
			
			<?php 
			$_SESSION['Nombrep'] = $_POST["TextName"];
			...
			$Grupo=$_POST['Grupo'];
				...
				$consultaIn="Insert into proyecto(Nombre,NumSprint,Descripcion,PO_Id,SM_Id) values('$Nombrep','$Numero','$Descripcion','$Owner','$Master')";
				if( mysqli_query($conIn, $consultaIn)){
					echo "Valores insertados";
					echo "<br>";

				}	
				Header( "Location: ActualizacionDatos.php" );	
	 		?>
